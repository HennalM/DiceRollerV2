...
public class MainActivity extends AppCompatActivity {
   ...
   public static int number = 0;
    ...
    public void DiceBreaker(View view) {
        ...
        TextView QUEST = this.findViewById(R.id.QUEST);
        ...
        try {
            int DiceRoll = Integer.parseInt(QUEST.getText().toString());

            if (DiceRoll == 1) {
                Questions.setText(QuestionList[0]);
            }
            if (DiceRoll == 2){
                Questions.setText(QuestionList[1]);
            }
            if (DiceRoll == 3){
                Questions.setText(QuestionList[2]);
            }
            if (DiceRoll == 4){
                Questions.setText(QuestionList[3]);
            }
            if(DiceRoll == 5){
                Questions.setText(QuestionList[4]);
            }
            if(DiceRoll == 6){
                Questions.setText(QuestionList[5]);
            }
            else if (DiceRoll == 0){
                Questions.setText("");
            }
        ...
        catch(Exception ex)
            {
                ...
                //Log.e("There is a Question Error", ex.toString());
            }
...
/*
        ...
        String Q2 = "If you were stranded on a desert island, what three things would you want to take with you?";
        String Q3 = "If you could eat only one food for the rest of your life, what would that be?";
        ...
        String Q6 = "If you found a magic lantern and a genie gave you three wishes, what would you wish?";
 */
//int QUEST = Integer.parseInt(QUEST.getText().toString());